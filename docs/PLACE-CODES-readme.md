...
Catalog lifecycle, sequential mint (`A000001` upward), and fuel-UI Canon display: [`CANON-PLACE-AND-CATALOG-RULES.md`](CANON-PLACE-AND-CATALOG-RULES.md). This file is the ID grammar, type/brand dictionaries, and SQL sketch. Do not fork a second type or brand table. The shape example below is grammar-only, not a mint recipe.
